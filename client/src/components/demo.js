...
export default function PaymentPage() {
  ...
  const [selectedCardType, setSelectedCardType] = useState('SELECT YOUR CARD TYPE');
      ...
      <div className='payment-container'>
        ...
        <div className='payment-section-two'>
          <div className='close-btn'>
            <Link to='/' className='close-link'><img className='close-icon' src={close} alt='close icon' /></Link>
          </div>
